...
import { FaHome, FaUser, FaBriefcase, FaFileUpload, FaBars } from "react-icons/fa";
import "../../styles/EmployerNav.css"; // Using same CSS
    ...
    <>
      ...
      <nav className={`employer-sidebar ${isMobile && isOpen ? "open" : ""}`}>
        ...
        <ul className="employer-sidebar__menu">
          ...
          <li>
            <NavLink
              to="/jobfinder/uploadcv"
              className={({ isActive }) =>
                isActive ? "employer-link active" : "employer-link"
              }
            >
              <FaFileUpload className="employer-icon" />
              <span>CV Upload</span>
            </NavLink>
          </li>
          <li>
            <NavLink
              to="/jobfinder/myprofile"
              className={({ isActive }) =>
                isActive ? "employer-link active" : "employer-link"
              }
            >
